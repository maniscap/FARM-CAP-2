...
flowchart TD
    ...
    subgraph Dashboard["🖥️ FarmCap 2 Central Command PWA"]
        ...
        GPSMeasure["🗺️ GPS Field Boundary & Acreage Surveyor"]:::client
...
│   │   ├── GPSMeasurement.jsx  # 🗺️ GPS field boundary surveyor & acreage calculator
...
│   ├── App.jsx                 # ⚛️ Root component & state management
