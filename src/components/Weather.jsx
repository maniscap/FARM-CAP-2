  ...
  return (
    <div style={styles.container} onTouchStart={onTouchStart} onTouchMove={onTouchMove} onTouchEnd={onTouchEnd}>
      ...
      <div style={styles.topBar}>
         <button onClick={() => navigate('/Consumer_HomePage')} style={styles.iconBtn}><IoMdArrowBack size={24}/></button>
...
const styles = {
  ...
  // --- FIXED: ADDED boxSizing & DECREASED BACKGROUND OPACITY ---
  searchOverlay: { position:'absolute', top:0, left:0, width:'100%', height:'100%', background:'rgba(0, 0, 0, 0.85)', backdropFilter: 'blur(30px) saturate(180%)', WebkitBackdropFilter:'blur(30px) saturate(180%)', zIndex:200, padding:'15px 12px', boxSizing: 'border-box', overflowX: 'hidden', display: 'flex', flexDirection: 'column' },
  searchHeader: { display:'flex', alignItems:'center', gap:'10px', marginBottom:'20px', background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(30px) saturate(200%)', padding: '12px 15px', borderRadius: '25px', border: '1px solid rgba(255,255,255,0.2)', borderTop: '1px solid rgba(255,255,255,0.5)', boxShadow: '0 10px 40px rgba(0, 0, 0, 0.3), inset 0 1px 2px rgba(255, 255, 255, 0.4)', boxSizing: 'border-box' },
  ...
  suggestionItem: { padding:'16px 15px', marginBottom:'12px', borderRadius: '20px', background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(20px) saturate(150%)', border: '1px solid rgba(255, 255, 255, 0.15)', borderTop: '1px solid rgba(255, 255, 255, 0.4)', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.2), inset 0 1px 2px rgba(255, 255, 255, 0.3)', cursor:'pointer', display:'flex', justifyContent:'space-between', alignItems:'center', fontSize:'16px', fontWeight: '600' },
  gpsRow: { display:'flex', alignItems:'center', gap:'10px', color:'#4CAF50', padding:'16px 15px', background:'rgba(76, 175, 80, 0.1)', backdropFilter: 'blur(20px)', borderRadius:'20px', border:'1px solid rgba(76, 175, 80, 0.3)', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.2)', fontWeight:'bold', cursor:'pointer', marginBottom: '20px' },
  gpsResultCard: { display:'flex', justifyContent:'space-between', alignItems:'center', padding:'16px 15px', background:'rgba(76, 175, 80, 0.15)', backdropFilter: 'blur(20px)', borderRadius:'20px', border:'1px solid rgba(76, 175, 80, 0.4)', borderTop: '1px solid rgba(76, 175, 80, 0.6)', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.2)', marginBottom:'15px', cursor:'pointer' },
  ...
  historyRow: { display:'flex', alignItems:'center', gap:'12px', padding:'16px 15px', marginBottom: '10px', background:'rgba(255,255,255,0.05)', backdropFilter: 'blur(20px)', borderRadius:'20px', border: '1px solid rgba(255,255,255,0.15)', borderTop: '1px solid rgba(255, 255, 255, 0.4)', cursor:'pointer', fontSize: '15px', fontWeight: '500' },
