...
export default function LocationModal({ isOpen, onClose, onLocationSelect }) {
  ...
  const styles = {
    ...
    content: { padding: '15px 12px', display: 'flex', flexDirection: 'column', height: '100%', boxSizing: 'border-box' },
    header: { display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px', background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(30px) saturate(200%)', padding: '12px 15px', borderRadius: '25px', border: '1px solid rgba(255,255,255,0.2)', borderTop: '1px solid rgba(255,255,255,0.5)', boxShadow: '0 10px 40px rgba(0, 0, 0, 0.3), inset 0 1px 2px rgba(255, 255, 255, 0.4)' },
    ...
    gpsBtn: { display: 'flex', alignItems: 'center', gap: '10px', color: '#4CAF50', padding: '16px 15px', background: 'rgba(76, 175, 80, 0.1)', backdropFilter: 'blur(20px)', borderRadius: '20px', border: '1px solid rgba(76, 175, 80, 0.3)', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.2)', fontWeight: 'bold', cursor: 'pointer', marginBottom: '20px' },
